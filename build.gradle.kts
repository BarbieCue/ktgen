...
dependencies {
    ...
    // ktor for testing
    testImplementation("io.ktor:ktor-server-core-jvm:3.1.0")
    testImplementation("io.ktor:ktor-server-netty-jvm:3.1.0")
    testImplementation("io.ktor:ktor-network:3.1.0")
