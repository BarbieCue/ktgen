...
dependencies {
    ...
    // ktor for testing
    testImplementation("io.ktor:ktor-server-core-jvm:2.3.8")
    testImplementation("io.ktor:ktor-server-netty-jvm:2.3.7")
    testImplementation("io.ktor:ktor-network:2.3.8")
