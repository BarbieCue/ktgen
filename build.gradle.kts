...
dependencies {
    ...
    testImplementation("io.kotest:kotest-assertions-json-jvm:5.7.1")
    testImplementation("io.kotest:kotest-assertions-core-jvm:5.7.2")
    testImplementation("io.kotest:kotest-property:5.7.1")

    // ktor for testing
    testImplementation("io.ktor:ktor-server-core-jvm:2.3.4")
    testImplementation("io.ktor:ktor-server-netty-jvm:2.3.4")
    testImplementation("io.ktor:ktor-network:2.3.4")
