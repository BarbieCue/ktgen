...
dependencies {
    ...
    // ktor for testing
    testImplementation("io.ktor:ktor-server-core-jvm:3.4.0")
    testImplementation("io.ktor:ktor-server-netty-jvm:3.4.0")
    testImplementation("io.ktor:ktor-network:3.4.0")

    testImplementation("ch.qos.logback:logback-classic:1.5.30")
}